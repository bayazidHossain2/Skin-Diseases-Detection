...
export default function Header() {
    const disSelect = 'text-lg cursor-pointer text-gray-600 hover:text-gray-600';
    ...
    return (
        <div>
            <nav class="relative px-4 py-4 flex justify-between items-start bg-orange-100">
                <a class=" flex flex-row text-orange-700 text-3xl font-bold leading-none" href="/home">
                    ...
                    <h2>Easy Skin Cure</h2>
                </a>
                {/* Mobile Menue */}
                <div class="md:hidden">
                    <button onClick={openMobileMenue} class="navbar-burger flex  text-orange-800 p-1">
                        <svg class="block h-6 w-6 fill-current" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <title>Mobile menu</title>
                            <path d="M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"></path>
                        </svg>
                    </button>
                    <ul className={showMobileMenue ? "flex flex-col space-y-2" : "hidden"}>
                ...
                <div className="hidden md:block">
                    {token
                        ? <div className="flex flex-row">
                            <div className="cursor-pointer lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200" onClick={ProfileListener}>{user.name}</div>
