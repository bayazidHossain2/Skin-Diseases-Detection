...
export default function Diseases() {
  ...
  return (
    <div className=' bg-orange-300'>
      ...
      <section class="max-w-[90%] mx-auto md:max-w-[80%]">
        <div class="w-full">
              ...
              (counter++ & 1) ?
                <div class="mx-auto grid grid-cols-1 gap-4 lg:grid-cols-3 pb-20">
                  <div class="order-1 lg:order-2 aspect-w-5 aspect-h-3 md:aspect-w-2 md:aspect-h-1 lg:aspect-w-3 lg:aspect-h-1">
                    <img src={dis.imageUrl ? 'http://localhost:8081/image/diseases?link=' + dis.imageUrl : avater} alt="background" className="object-cover rounded-lg" />
                  </div>
                  <div
